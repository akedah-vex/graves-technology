...
export default function Home() {
  return (
    <div className="min-h-screen bg-neutral-950 font-sans text-white"> {/* Changed background to near-black */}
      ...
      <header className="bg-neutral-900 shadow sticky top-0 z-50 border-b border-neutral-800/70"> {/* Updated classes */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-blue-400 tracking-wider">Graves Technology</h1> {/* Keep branding color */}
          <nav>
          </nav>
        </div>
      </header>
      ...
      <section className="bg-neutral-950 pt-32 pb-48 text-white border-b border-neutral-800/70 min-h-[75vh] flex items-center"> {/* Updated classes */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col justify-center items-center">
          ...
          <h1 className="text-5xl md:text-7xl pb-6 pt-10 font-extrabold tracking-tight mb-4 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-400"> {/* Keep gradient styling */}
            Graves Technology
          </h1>
          {/* Original Headline */}
          <h2 className="text-5xl md:text-7xl font-extrabold tracking-widest mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-400"> {/* Keep gradient styling */}
            Your Digital Life, Under Your Control.
          </h2>
          <p className="mt-4 text-xl md:text-2xl max-w-3xl mx-auto text-gray-400 mb-10"> {/* Use standard text classes */}
